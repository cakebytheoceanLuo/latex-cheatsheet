...
\redtext{\hlgray{$\rightarrow$ 30 for SEQUENCE\_OF, 12 for all Nums}}
...
\lstinline{[{"jsonrpc": "2.0", "result": 7, "id": "1"/*]*/, {"jsonrpc": "2.0", "error": {"code": -32600, "message": "Invalid Request"/*]*/, "id": null/*]*/, {"jsonrpc": "2.0", "error": {"code": -32601, "message": "Method not found"/*]*/, "id": "5"/*]*/, {"jsonrpc": "2.0", "result": ["hello", 5], "id": "9"/*]*/]}
%
%
%
\\
