...
\\
\redtext{8 Fallacies}
\bluetext{1.Network Reliable} 
\orangetext{Assumptions:}Power Supply, Hard Disk, Node Failures, Config., Bugs
\orangetext{Effect:}APP hangs, crashes 
\orangetext{Countermeasures:}
...
\bluetext{2.Latency\begin{CJK*}{UTF8}{gbsn}延迟\end{CJK*} Is Zero}
...
\bluetext{3.Bandwidth is infinite.
